...
public class CallScreeningRoleBehavior implements RoleBehavior {
    ...
    public boolean isVisibleAsUser(@NonNull Role role, @NonNull UserHandle user,
            @NonNull Context context) {
        return VisibilityMixin.isVisible("config_showDefaultCallScreening", context);
    }

    @Nullable
    private static String getDefaultHolder(@NonNull Role role, @NonNull Context context) {
        return ExclusiveDefaultHolderMixin.getDefaultHolder(role, "config_defaultCallScreening", context);
    }
